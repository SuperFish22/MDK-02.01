...
* [МДК 02.01. Разработка кода ИС](#мдк-0502-разработка-кода-информационных-систем)
...
* [МДК 05.01 Проектирование,разработка кода и тестирования информационных систем](#мдк-0503-тестирование-информационных-систем)

* [Полезное](#полезное)

## МДК. 02.01 Разработка кода информационных систем
...
1. [Модель проектирования (диаграммы классов, диаграммы деятельности)](articles/uml_mp_dc_dd.md)
...
## МДК 05.01 Проектирование,разработка кода и тестирования информационных систем
